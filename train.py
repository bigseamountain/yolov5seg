...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    accumulate = max(round(nbs / batch_size), 1)  # accumulate loss labelme_dataset optimizing
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=r'E:\seg-master\runs\train-seg\exp9\weights\best.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/seg.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=r'E:\seg-master\data\custom.yaml', help='dataset.yaml path')
